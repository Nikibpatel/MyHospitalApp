        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                my.h_reg(ed_h_name.getText().toString(),ed_h_email.getText().toString(), ed_h_password.getText().toString(),
                        ed_h_contact.getText().toString(),ed_h_city.getText().toString(),h_status,ed_h_area.getText().toString(),
                        new Callback<Response>() {
                            ...
                            public void success(Response response, Response response2) {
                                ...
                                Intent i=new Intent(h_reg.this,h_dashboard.class);
                                startActivity(i);
